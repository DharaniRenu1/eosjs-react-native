...
export default class Share1 extends React.Component {
...
<Text style={{ color: "#000000",fontSize:20,textDecorationLine: 'underline',textAlign:'center'}}          onPress={() =>this.props.navigation.navigate(navi)}
      onPress={() => {
              onSignIn().then(() => this.props.navigation.navigate("Profile"));
            }}  >May Be Later</Text>
    </ScrollView>
 </View>
      );
